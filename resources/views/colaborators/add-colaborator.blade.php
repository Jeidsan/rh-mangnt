<x-layout-app app-title="Novo colaborador">
    ...
    <div class="w-100 p-4">
        ...
        <form action="{{ route('rh-users.management.create-colaborator') }}" method="post">
            ...
            <div class="container-fluid">
                ...
                <div class="mt-3">
                    <a href="{{ route('rh-users.management.home') }}" class="btn btn-outline-danger me-3">Cancel</a>
