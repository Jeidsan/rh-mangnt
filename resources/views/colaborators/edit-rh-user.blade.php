<x-layout-app app-title="Edit RH User">
    ...
    <div class="w-100 p-4">
        ...
        <form action="{{ route('rh-users.update-colaborator') }}" method="post">
            ...
            <div class="container-fluid">
                ...
                <div class="mt-3">
                    <a href="{{ route('rh-users') }}" class="btn btn-outline-danger me-3">Cancel</a>
